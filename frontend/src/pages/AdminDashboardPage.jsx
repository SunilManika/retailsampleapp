...
import SystemAnalysisTab from "../components/SystemAnalysisTab";
...
function AdminDashboardPage() {
  ...
  return (
    <div className="page">
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            fontSize: "14px",
            fontWeight: 600,
            background: activeTab === "system-analysis" ? "white" : "transparent",
            color: activeTab === "system-analysis" ? "#2563eb" : "#6b7280",
            border: "none",
            borderBottom: activeTab === "system-analysis" ? "2px solid #2563eb" : "2px solid transparent",
            marginBottom: "-2px",
            cursor: "pointer",
            transition: "all 0.2s"
          }}
      ...
      {/* System Analysis Tab Content */}
      {activeTab === "system-analysis" && <SystemAnalysisTab />}
    </div>
  );
}
